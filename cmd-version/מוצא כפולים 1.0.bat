...
::במידה ונמצאו 2 מופעים של קטע שם זהה
::מתבצע חיפוש של קטע זה ברשימת הקבצים
::והתוצאה מוכנסת לקובץ זמני
if %num% gtr 1 dir /b | find "%file_tokens%">%del_file_tmp%

::לאחר מכן מתבצעת בדיקה אם הקבצים קיימים כבר ברשימה הראשית 
::ובמידה ולא הם מוכנסים לרשימה הראשית
